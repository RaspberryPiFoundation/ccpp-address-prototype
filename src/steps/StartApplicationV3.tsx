...
/**
 * Step 1 for the v3 variant only. A copy of StartApplication so v3's spacing can
 * be iterated on without moving the other variants — the "start-v3" class on the
 * card scopes those tweaks (see global.css).
 */
export function StartApplicationV3({ data, update, onContinue }: Props) {
